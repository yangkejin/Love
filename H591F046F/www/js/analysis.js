...
upDownRefresh.addHeaderRefreshing(function() {
	var datas = new Datas();
	datas.GetAnalyiseReportList("1d60bda6-6943-4c09-b37a-19005883411c", ReportTimeType, startTime_btn_text.innerText, endTime_btn_text.innerText, function(DBData) {
		if(DBData) {
